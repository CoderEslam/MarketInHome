 ...
 */
public class ProductSliderBannerViewHolder extends RecyclerView.ViewHolder {
    private ViewPager bannerSliderViewPager;
    private int currentPage;
    private Timer timer;
    private final long DELAY_TIME = 2000;
    private final long PERIOD_TIME = 2000;
    public ProductSliderBannerViewHolder(@NonNull View itemView) {
        super(itemView);
        bannerSliderViewPager = itemView.findViewById(R.id.banner_slier_view_pager);
    }

    public void setBannerSliderViewPager(ArrayList<String> list) {
        currentPage = 2;
        //////////////////////////////////////////////////////////////////
