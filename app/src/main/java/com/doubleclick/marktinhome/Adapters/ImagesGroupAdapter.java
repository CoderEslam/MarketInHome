...
public class ImagesGroupAdapter extends RecyclerView.Adapter<ImagesGroupAdapter.ImagesGroupViewHolder>{
    @NonNull
    @Override
    public ImagesGroupAdapter.ImagesGroupViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ImagesGroupAdapter.ImagesGroupViewHolder holder, int position) {
